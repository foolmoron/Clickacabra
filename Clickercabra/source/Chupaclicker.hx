...
class Chupaclicker
{
	...
	public static var PROPERTIES:Map<String, { onBuy:Dynamic->Void, costString:Dynamic->String, canBuy:Dynamic->Bool }> = [
		...
		"M"=> {
			...
			costString: function(data:Dynamic) { return "Create a Mother with 50 Chupacabras and " + formatBigNum(300 * Math.pow(2, data.M), 0) + " Flesh!"; },
		...
		"N"=> {
			...
			costString: function(data:Dynamic) { return "Create a Nest with 50 Daywalkers and " + formatBigNum(300 * Math.pow(2, data.N), 0) + " Flesh!"; },
		...
		"G"=> {
			...
			costString: function(data:Dynamic) { return "Upgrade your Goat Farm with " + formatBigNum(500 * Math.pow(2, data.G), 0) + " Flesh!"; },
		...
		"P"=> {
			...
			costString: function(data:Dynamic) { return "Upgrade your Goat Farm with " + formatBigNum(500 * Math.pow(2, data.P), 0) + " Flesh!"; },
